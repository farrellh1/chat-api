class Conversation < ApplicationRecord
  ...
  scope :show_messages, lambda { |sender_id, recipient_id|
                          where('(sender_id = ? AND recipient_id = ?) OR (sender_id = ? AND recipient_id = ?)', sender_id, recipient_id, recipient_id, sender_id).first
                        }
end
